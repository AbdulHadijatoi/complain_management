    ...
    <form action="{{ route('updateComplaint', $complaint->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="block block-rounded">
        <div class="block-header block-header-default">
          <h3 class="block-title">{{ __('Edit Complaint') }}</h3>
        </div>
        <div class="block-content block-content-full">
          <div class="row">
            ...
            <div class="form-group col-md-4 mb-4">
              ...
              <select class="form-select" id="status" name="status" style="width: 100%;" data-placeholder="{{ __('Select Status') }}">
                <option></option>
            ...
            <div class="form-group col-md-4 mb-4">
              ...
              <select class="form-select" id="type_of_fault" name="type_of_fault" style="width: 100%;" data-placeholder="{{ __('Select Type of Fault') }}">
                <option></option>
            ...
            <div class="form-group col-md-4 mb-4">
              ...
              <select class="form-select" id="comuna" name="comuna" style="width: 100%;" data-placeholder="{{ __('Select Comuna') }}">
                <option></option>
            ...
            <div class="form-group col-md-4 mb-4">
              ...
              <select class="form-select" id="sector" name="sector" style="width: 100%;" data-placeholder="{{ __('Select Sector') }}">
                <option></option>
            ...
            <div class="form-group col-md-4 mb-4">
              ...
              <select class="form-select" id="population" name="population" style="width: 100%;" data-placeholder="{{ __('Select Population') }}">
                <option></option>
            ...
            <div class="form-group col-12 mb-4">
              <button type="submit" class="btn btn-alt-primary col-12">{{ __('Update Complaint') }}</button>
            </div>
          </div>
        </div>
      </div>
